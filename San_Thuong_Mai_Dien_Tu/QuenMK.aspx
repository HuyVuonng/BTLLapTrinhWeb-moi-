<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuenMK.aspx.cs" Inherits="San_Thuong_Mai_Dien_Tu.QuenMK" %>
...
<body>
    ...
    <!-- modal-header-->
    <form id="form1" onsubmit="return checkQuenMK()" runat="server">
            ...
            <div class="auth-form" id="auth-form-register">
                <div class="auth-form_container" id="auth-form_container-register">
                    ...
                    <div class="auth-form_form">
                        ...
                        <div class="auth-form_group">
                            <input type="password" class="auth-form_input" id="NhapLaiMK" name="NhapLaiMK" placeholder="Nhập lại mật khẩu của bạn">
                        </div>
