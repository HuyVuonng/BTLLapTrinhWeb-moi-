<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DkBanHang.aspx.cs" Inherits="San_Thuong_Mai_Dien_Tu.DkBanHang" %>
...
<body>
    ...
    <!-- modal-header-->
    <form id="form1" onsubmit="return checkDKBanHang()" runat="server">
                ...
                <div class="auth-form_container" id="auth-form_container-register">
                    ...
                    <div class="auth-form_form">
                        <div class="auth-form_group">
                            <input type="text" class="auth-form_input" id="Ten" name="Ten" placeholder="Nhập tên shop của bạn">
                        </div>

                        
                        <div class="auth-form_group">
                            <input type="text" class="auth-form_input" id="SDT" name="SDT" placeholder="Nhập số điện thoại của shop bạn">
                        </div>

                        
                        <div class="auth-form_group">
                            <input type="text" class="auth-form_input" id="DiaChi" name="DiaChi" placeholder="Nhập địa chỉ shop của bạn">
                        </div>
