...
namespace Shop.Data
{
    public class ShopList
    {
        ...
        private string s_MatKhau;
        private string s_DiaChi;
        private string s_SDT;

        public ShopList(int ma, string ten, string TaiKhoan, string MatKhau, string SDT, string DiaChi)
        {
            this.S_MaShop = ma;
            this.S_TenShop = ten;
            this.S_TaiKhoan = TaiKhoan;
            this.S_MatKhau = MatKhau;
            this.S_SDT = SDT;
        ...
        public string S_MatKhau { get => s_MatKhau; set => s_MatKhau = value; }
